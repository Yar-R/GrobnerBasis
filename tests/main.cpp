...
bool matrix_f5() {
    Input<double , int> input = {
            Polynomial<double, int>({{3, {3, 10}}, {1, {2, 1}}, {10, {0, 1}}}),
            Polynomial<double, int>({{1, {1, 9}}, {1, {}}}),
            Polynomial<double, int>({{3, {4, 19}}, {4, {3, 10}}, {1, {2, 1}}, {10, {1, 10}}, {10, {0, 1}}})
    };
    MatrixF5(input, Lex<int>(), 10, 2);
}
